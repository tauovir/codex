# Generated by Django 3.0.6 on 2022-04-23 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateField(default=datetime.date.today)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resume.Languages')),
                ('language_profiency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resume.Language_Proficiency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resume.Technology_Category')),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
            fields=[
                ...
                ('technology', models.ManyToManyField(to='resume.Technologies')),
            ],
            options={
